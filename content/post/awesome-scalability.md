...
更新和整理的阅读清单，用于说明可伸缩，可靠和高性能的大型系统的模式。在这些清理中的知名工程师的文章和可靠的资料里，对相关概念进行了解释说明。案例研究来自服务于数百万至数十亿用户的、经过实战检验的系统。

<!--more-->

源文: [Awesome Scalability](https://github.com/binhnguyennus/awesome-scalability)
...
## 原则
* [巨型服务的经验教训--加州大学伯克利分校和谷歌公司的Eric Brewer](https://people.eecs.berkeley.edu/~brewer/papers/GiantScale-IEEE.pdf)
* [构建大型分布式系统的设计、经验和建议 - Jeff Dean, Google](https://www.cs.cornell.edu/projects/ladis2009/talks/dean-keynote-ladis2009.pdf)
* [如何设计一个好的API以及它的重要性--Joshua Bloch，CMU和Google。](https://www.infoq.com/presentations/effective-api-design)
* [关于效率、可靠性、扩展--James Hamilton，AWS公司副总裁](http://mvdirona.com/jrh/work/)
* [构建企业平台时应注意的事项 - Heidi Williams，Box公司平台副总裁](https://blog.box.com/blog/4-things-to-keep-in-mind-when-building-a-platform-for-the-enterprise/)
* [混沌工程原理](https://www.usenix.org/conference/srecon17americas/program/presentation/rosenthal)
* [在混沌中寻找秩序](https://www.usenix.org/conference/srecon16/program/presentation/lueder)
* [十二要素应用](https://12factor.net/)
* [清晰架构](https://8thlight.com/blog/uncle-bob/2012/08/13/the-clean-architecture.html)
* [高内聚、低耦合](http://www.math-cs.gordon.edu/courses/cs211/lectures-2009/Cohesion,Coupling,MVC.pdf)
* [单体和微服务](https://medium.com/@SkyscannerEng/monoliths-and-microservices-8c65708c3dbf)
* [CAP定理和权衡](http://robertgreiner.com/2014/08/cap-theorem-revisited/)
* [CP 数据库 和 AP 数据库](https://blog.andyet.com/2014/10/01/right-database)
* [无状态与有状态的可伸缩性](http://ithare.com/scaling-stateful-objects/)	
* [垂直伸缩和水平伸缩](https://www.brianjgraf.com/scalability-scale-up-scale-out-care/)
* [垂直伸缩对比水平伸缩: 隐形成本](https://blog.codinghorror.com/scaling-up-vs-scaling-out-hidden-costs/)
* [ACID 与 BASE](https://neo4j.com/blog/acid-vs-base-consistency-models-explained/)
* [阻塞/非阻塞 和 同步/异步](https://blogs.msdn.microsoft.com/csliu/2009/08/27/io-concept-blockingnon-blocking-vs-syncasync/)
* [数据库的性能和可伸缩性](https://use-the-index-luke.com/sql/testing-scalability)
* [数据库隔离级别及对性能和可扩展性的影响](http://highscalability.com/blog/2011/2/10/database-isolation-levels-and-their-effects-on-performance-a.html)
* [大型集群中数据丢失的概率分析](https://martin.kleppmann.com/2017/01/26/data-loss-in-large-clusters.html)
* [高可扩展解决方案的数据访问。使用SQL、NoSQL和Polyglot持久性技术](https://docs.microsoft.com/en-us/previous-versions/msp-n-p/dn271399(v=pandp.10))
* [SQL vs NoSQL](https://www.upwork.com/hiring/data/sql-vs-nosql-databases-whats-the-difference/)
* [SQL vs NoSQL - Salesforce的经验教训](https://engineering.salesforce.com/sql-or-nosql-9eaf1d92545b)
* [NoSQL 数据库: 调查和决策指南](https://medium.baqend.com/nosql-databases-a-survey-and-decision-guidance-ea7823a822d)
...
* [不要被哈希技巧所欺骗](https://booking.ai/dont-be-tricked-by-the-hashing-trick-192a6aae3087)
* [在Netflix的统一一致的哈希](https://medium.com/netflix-techblog/distributing-content-to-open-connect-3e3e391d4dc9)
* [最终一致性 - Werner Vogels,Amazon公司CTO](https://www.allthingsdistributed.com/2008/12/eventually_consistent.html)
...
* [每一个程序员都应该知道的延迟数字](http://norvig.com/21-days.html#answers)
* [服务可用性微积分](https://queue.acm.org/detail.cfm?id=3096459&__s=dnkxuaws9pogqdnxmx8i)
* [扩展Web应用时的架构问题。瓶颈、数据库、CPU、IO](http://highscalability.com/blog/2014/5/12/4-architecture-issues-when-scaling-web-applications-bottlene.html)	
* [常见瓶颈](http://highscalability.com/blog/2012/5/16/big-list-of-20-common-bottlenecks.html)
* [分布式交易背后的秘密](https://queue.acm.org/detail.cfm?id=3025012)
* [依靠软件在不同层级可靠地重定向流量](https://www.usenix.org/conference/srecon15/program/presentation/taveira)
* [有目的的打破固事物](https://www.usenix.org/conference/srecon17americas/program/presentation/andrus)
* [避免过充工程](https://medium.com/@rdsubhas/10-modern-software-engineering-mistakes-bc67fbef4fc8)
* [可伸缩性最差实践](https://www.infoq.com/articles/scalability-worst-practices)
* [使用稳定的技术--不要重新发明轮子--保持简单!](https://medium.com/@DataStax/instagram-engineerings-3-rules-to-a-scalable-cloud-application-architecture-c44afed31406)
* [Simplicity by Distributing Complexity](https://jobs.zalando.com/tech/blog/simplicity-by-distributing-complexity/)
* [为什么过度重用是坏事](http://tech.transferwise.com/why-over-reusing-is-bad/)
* [性能是一个特性](https://blog.codinghorror.com/performance-is-a-feature/)
* [让性能成为工作流程的一部分](https://codeascraft.com/2014/12/11/make-performance-part-of-your-workflow/)
...
* [自动化和抽象：Facebook的教训](https://architecht.io/lessons-from-facebook-on-engineering-for-scale-f5716f0afc7a)
* [AWS的做与不做](https://8thlight.com/blog/sarah-sunday/2017/09/15/aws-dos-and-donts.html)
* [UI设计不可伸缩性 - Stanley Wood, Design Director at Spotify](https://medium.com/@hellostanley/design-doesnt-scale-4d81e12cbc3e)
* [Linux 性能](http://www.brendangregg.com/linuxperf.html)
* [构建快速而有弹性的Web应用 - Ilya Grigorik](https://www.igvita.com/2016/05/20/building-fast-and-resilient-web-applications/)
* [接受部分故障，将服务损失降到最低限度](https://www.usenix.org/conference/srecon17asia/program/presentation/wang_daxin)
...
* [水平伸缩设计](https://docs.microsoft.com/en-us/azure/architecture/guide/design-principles/scale-out)	
...
## 可伸缩性
* [微服务和服务编排](https://martinfowler.com/microservices/)
	* [Uber公司面向领域的微服务架构](https://eng.uber.com/microservice-architecture/)
	* [Riot Games的容器 (8部分)实践](https://engineering.riotgames.com/news/thinking-inside-container)
	* [容器化在Pinterest的应用](https://medium.com/@Pinterest_Engineering/containerization-at-pinterest-92295347f2f3)
	* [容器在Netflix使用的演变](https://medium.com/netflix-techblog/the-evolution-of-container-usage-at-netflix-3abfc096781b)
	* [在Uber实现MySQL的Docker化](https://eng.uber.com/dockerizing-mysql/)
	* [Spotify的微服务测试](https://labs.spotify.com/2018/01/11/testing-of-microservices/)
	* [Treehouse的在生产中Docker实践](https://medium.com/treehouse-engineering/lessons-learned-running-docker-in-production-5dce99ece770)
	* [SoundCloud的微服务](https://developers.soundcloud.com/blog/inside-a-soundcloud-microservice)
	* [在Stripe可靠地运行Kubernetes](https://stripe.com/blog/operating-kubernetes)
	* [在Trivago使用Istio进行跨集群流量镜像](https://tech.trivago.com/2020/06/10/cross-cluster-traffic-mirroring-with-istio/)
	* [英国广播公司的Nanoservices](https://medium.com/bbc-design-engineering/powering-bbc-online-with-nanoservices-727840ba015b)
	* [PowerfulSeal: 彭博社Kubernetes集群的测试工具](https://www.techatbloomberg.com/blog/powerfulseal-testing-tool-kubernetes-clusters/)
	* [Conductor: Netflix的微服务编排](https://medium.com/netflix-techblog/netflix-conductor-a-microservices-orchestrator-2e8d4771bf40)
	* [Docker容器为Shopify的100.000多个在线商店提供支撑](https://shopifyengineering.myshopify.com/blogs/engineering/docker-at-shopify-how-we-built-containers-that-power-over-100-000-online-shops)
	* [Medium公司的微服务架构](https://medium.engineering/microservice-architecture-at-medium-9c33805eb74f)
	* [From bare-metal to Kubernetes at Betabrand](https://boxunix.com/post/bare_metal_to_kube/)
	* [Tinder公司的K8s实践](https://medium.com/tinder-engineering/tinders-move-to-kubernetes-cda2a6372f44)
	* [Quora公司的K8s实践](https://www.quora.com/q/quoraengineering/Adopting-Kubernetes-at-Quora)	
	* [Pinterest公司的K8s平台](https://medium.com/pinterest-engineering/building-a-kubernetes-platform-at-pinterest-fb3d9571c948)
	* [Nubank的微服务实践](https://medium.com/building-nubank/microservices-at-nubank-an-overview-2ebcb336c64d)
	* [GRIT: eBay跨微服务的分布式协议](https://tech.ebayinc.com/engineering/grit-a-protocol-for-distributed-transactions-across-microservices/)
	* [Rubix: Palantir的K8s实践](https://medium.com/palantir/introducing-rubix-kubernetes-at-palantir-ab0ce16ea42e)
* [分布式缓存](https://www.wix.engineering/single-post/scaling-to-100m-to-cache-or-not-to-cache)
	* [EVCache: Netflix的分布式内存缓存技术](https://medium.com/netflix-techblog/caching-for-a-global-netflix-7bcc457012f1)
	* [EVCache Cache Warmer基础架构在Netflix的应用](https://medium.com/netflix-techblog/cache-warming-agility-for-a-stateful-service-2d3b1da82642)
	* [Memsniff: Box公司强大的Memcache流量分析器](https://blog.box.com/blog/introducing-memsniff-robust-memcache-traffic-analyzer/)
	* [Caching with Consistent Hashing and Cache Smearing at Etsy](https://codeascraft.com/2017/11/30/how-etsy-caches/)
	* [Facebook的图片缓存分析](https://code.facebook.com/posts/220956754772273/an-analysis-of-facebook-photo-caching/)
	* [在Facebook的缓存效率练习](https://code.facebook.com/posts/964122680272229/web-performance-cache-efficiency-exercise/)
	...
	* [在Trivago将Memcached内存使用量减少50%](http://tech.trivago.com/2017/12/19/how-trivago-reduced-memcached-memory-usage-by-50/)
	* [缓存内部服务,Yelp公司](https://engineeringblog.yelp.com/2018/03/caching-internal-service-calls-at-yelp.html)
	* [在Allegro使用大数据估算缓存效率](https://allegro.tech/2017/01/estimating-the-cache-efficiency-using-big-data.html)
	* [Zalando的分布式缓存](https://jobs.zalando.com/tech/blog/distributed-cache-akka-kubernetes/)
	* [NetFlix公司从RAM到SSD的应用数据缓存化](https://medium.com/netflix-techblog/evolution-of-application-data-caching-from-ram-to-ssd-a33d6fa7a690)
	* [Skyscanner重复缓存的权衡](https://medium.com/@SkyscannerEng/the-tradeoffs-of-a-replicated-cache-b6680c722f58)
	* [Avoiding Cache Stampede at DoorDash](https://blog.doordash.com/avoiding-cache-stampede-at-doordash-55bbf596d94b)
	* [在Yext使用Quadtrees进行位置缓存](http://engblog.yext.com/post/geolocation-caching)
	* [Vimeo的视频元数据缓存功能](https://medium.com/vimeo-engineering-blog/video-metadata-caching-at-vimeo-a54b25f0b304)
	...
	* [在Slack上使用Redis扩展作业队列](https://slack.engineering/scaling-slacks-job-queue-687222e9d100)
	* [在Github上将持久性数据从Redis中移出](https://githubengineering.com/moving-persistent-data-out-of-redis/)
	* [在Instagram的Redis中存储数以亿计的简单键值对](https://engineering.instagram.com/storing-hundreds-of-millions-of-simple-key-value-pairs-in-redis-1091ae80f74c)
	* [Trivago公司的Redis实践](http://tech.trivago.com/2017/01/25/learn-redis-the-hard-way-in-production/)
	* [优化Deliveroo的Redis存储](https://deliveroo.engineering/2017/01/19/optimising-membership-queries.html)
	* [Redis中的内存优化在Wattpad上的应用](http://engineering.wattpad.com/post/23244724794/store-more-stuff-memory-optimization-in-redis)
	* [Redis Fleet at Heroku](https://blog.heroku.com/rolling-redis-fleet)
	* [在SoundCloud解决远程构建缓存缺失的问题（2部分）](https://developers.soundcloud.com/blog/gradle-remote-build-cache-misses-part-2)
...
* [分布式跟踪，追踪，测量](https://www.oreilly.com/ideas/understanding-the-value-of-distributed-tracing)
...
* [分布式监控和警告](https://www.oreilly.com/ideas/monitoring-distributed-systems)
...
* [分布式消息，队列，事件流](https://arxiv.org/pdf/1704.00411.pdf)
...
* [分布式存储库、依赖性和配置管理](https://betterexplained.com/articles/intro-to-distributed-version-control-illustrated/)
...
* [大数据](https://insights.sei.cmu.edu/sei_blog/2017/05/reference-architectures-for-big-data-systems.html)	
	...
	* [DoorDash的数据平台](https://doordash.engineering/2020/09/25/how-doordash-is-scaling-its-data-platform/)
	* [Khan Academy数据平台](http://engineering.khanacademy.org/posts/khanalytics.htm)
	* [Airbnb的数据基础设施](https://medium.com/airbnb-engineering/data-infrastructure-at-airbnb-8adfb34f169c)
	* [LinkedIn的数据基础设施](https://www.infoq.com/presentations/big-data-infrastructure-linkedin)
	* [GO-JEK的数据基础设施](https://blog.gojekengineering.com/data-infrastructure-at-go-jek-cd4dc8cbd929)
	* [Pinterest的数据挖掘基础设施](https://medium.com/@Pinterest_Engineering/scalable-and-reliable-data-ingestion-at-pinterest-b921c2ee8754)
	...
	* [Uber的大数据处理](https://cdn.oreillystatic.com/en/assets/1/event/160/Big%20data%20processing%20with%20Hadoop%20and%20Spark%2C%20the%20Uber%20way%20Presentation.pdf)
	* [Lyft的分析管道](https://cdn.oreillystatic.com/en/assets/1/event/269/Lyft_s%20analytics%20pipeline_%20From%20Redshift%20to%20Apache%20Hive%20and%20Presto%20Presentation.pdf)
	* [Grammarly的分析管道](https://tech.grammarly.com/blog/building-a-versatile-analytics-pipeline-on-top-of-apache-spark)
	* [Teads的分析管道](https://medium.com/teads-engineering/give-meaning-to-100-billion-analytics-events-a-day-d6ba09aa8f44)
	* [用于PayPal的实时欺诈防范的机器学习数据管道](https://www.infoq.com/presentations/paypal-ml-fraud-prevention-2018)
	* [LinkedIn的大数据分析和机器学习技术](https://cdn.oreillystatic.com/en/assets/1/event/269/Big%20data%20analytics%20and%20machine%20learning%20techniques%20to%20drive%20and%20grow%20business%20Presentation%201.pdf)
	* [LinkedIn的Hadoop自助报告平台](https://cdn.oreillystatic.com/en/assets/1/event/137/Building%20a%20self-serve%20real-time%20reporting%20platform%20at%20LinkedIn%20Presentation%201.pdf)
	* [LinkedIn的隐私保护分析与报告](https://engineering.linkedin.com/blog/2019/04/privacy-preserving-analytics-and-reporting-at-linkedin)
	* [用于跟踪沃尔玛商品供应情况的分析平台](https://medium.com/walmartlabs/how-we-build-a-robust-analytics-platform-using-spark-kafka-and-cassandra-lambda-architecture-70c2d1bc8981)
	* [HALO：Facebook的硬件分析和生命周期优化](https://code.fb.com/data-center-engineering/hardware-analytics-and-lifecycle-optimization-halo-at-facebook/)
	* [RBEA：King的实时分析平台](https://techblog.king.com/rbea-scalable-real-time-analytics-king/)
	* [AresDB：Uber的GPU驱动实时分析引擎](https://eng.uber.com/aresdb/)
	* [AthenaX：Uber的流媒体分析平台](https://eng.uber.com/athenax/)
	* [Delta: Netflix的数据同步和增强平台](https://medium.com/netflix-techblog/delta-a-data-synchronization-and-enrichment-platform-e82c36a79aee)
	* [Keystone.Netflix的实时流处理平台](https://medium.com/netflix-techblog/keystone-real-time-stream-processing-platform-a3ee651812a)
	* [Databook: 在Uber用元数据将大数据转化为知识](https://eng.uber.com/databook/)
	* [Amundsen：Lyft的数据发现和元数据引擎](https://eng.lyft.com/amundsen-lyfts-data-discovery-metadata-engine-62d27254fbb9)
	* [Maze：Uber的漏斗可视化平台](https://eng.uber.com/maze/)
	* [Metacat: 让大数据在Netflix变得可发现和有意义](https://medium.com/netflix-techblog/metacat-making-big-data-discoverable-and-meaningful-at-netflix-56fb36a53520)
	* [SpinalTap：Airbnb的变化数据采集系统](https://medium.com/airbnb-engineering/capturing-data-evolution-in-a-service-oriented-architecture-72f7c643ee6f)
	* [Accelerator: eBay的快速数据处理框架](https://www.ebayinc.com/stories/blogs/tech/announcing-the-accelerator-processing-1-000-000-000-lines-per-second-on-a-single-computer/)
	* [Omid: 雅虎交易处理平台](https://yahooeng.tumblr.com/post/180867271141/a-new-chapter-for-omid)
	* [TensorFlowOnSpark: 在雅虎大数据集群上进行分布式深度学习](https://yahooeng.tumblr.com/post/157196488076/open-sourcing-tensorflowonspark-distributed-deep)
	* [Spark on Scala: Adobe公司的分析参考架构](https://medium.com/adobetech/spark-on-scala-adobe-analytics-reference-architecture-7457f5614b4c)
	* [在Spotify的实验平台（2部分）](https://engineering.atspotify.com/2020/11/02/spotifys-new-experimentation-platform-part-2/)
	...
	* [LINE公司的日志分析平台](https://www.slideshare.net/wyukawa/strata2017-sg)
	...
	* [在Netflix构建和扩展数据](https://medium.com/netflix-techblog/building-and-scaling-data-lineage-at-netflix-to-improve-data-infrastructure-reliability-and-1a52526a7977)
	* [为Pinterest的计算机视觉任务构建一个可扩展的数据管理系统](https://medium.com/@Pinterest_Engineering/building-a-scalable-data-management-system-for-computer-vision-tasks-a6dee8f1c580)
	* [Etsy的结构化数据](https://codeascraft.com/2019/07/31/an-introduction-to-structured-data-at-etsy/)
	* [拓展成熟的数据管道--Airbnb的管理开销](https://medium.com/airbnb-engineering/scaling-a-mature-data-pipeline-managing-overhead-f34835cbc866)
	* [Airbnb的Spark分区策略](https://medium.com/airbnb-engineering/on-spark-hive-and-small-files-an-in-depth-look-at-spark-partitioning-strategies-a9a364f908)
