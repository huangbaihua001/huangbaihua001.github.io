...
更新和整理的阅读清单，用于说明可伸缩，可靠和高性能的大型系统的模式。阅读清单是知名工程师的文章以及来源可靠的资料，这些内容对可伸缩性等相关概念进行了很好地解释。案例研究也都来自于服务于数百万至数十亿用户的、经过实战检验的系统。
...
* [有目的的打破固有事物](https://www.usenix.org/conference/srecon17americas/program/presentation/andrus)
